...
import com.vavill.ui.xml.adapter.ViewPagerAdapter
...
import com.vavill.ui.xml.databinding.FragmentExchangeRatesBinding
...
class ExchangeRatesFragment : Fragment() {
    ...
    private fun changeSortIcon(sortView: CardView, sortType: SortType) {
        ...
        when (sortType) {
            SortType.ALPHA_ASC -> imageView.setImageResource(com.vavill.common.R.drawable.ic_sort_alpha_asc)
            SortType.ALPHA_DESC -> imageView.setImageResource(com.vavill.common.R.drawable.ic_sort_alpha_desc)
            SortType.NUMERIC_ASC -> imageView.setImageResource(com.vavill.common.R.drawable.ic_sort_numeric_asc)
            SortType.NUMERIC_DESC -> imageView.setImageResource(com.vavill.common.R.drawable.ic_sort_numeric_desc)
        }
    }
    ...
    private fun sortByAlphabetOnClick(sortByAlphabet: CardView) {
        sortByAlphabet.setOnClickListener {
            ...
            viewModel.setSortType(currentSortType)
            changeSortIcon(sortByAlphabet, currentSortType)
            setHighlightForCurrentSortType(sortByAlphabet)
        }
    }
    ...
    private fun setHighlightForCurrentSortType(sortView: CardView) {
        (sortView.parent as LinearLayout).children.forEach {
            (it as CardView).setCardBackgroundColor(
                resources.getColor(
                    com.vavill.common.R.color.white,
                    resources.newTheme()
                )
            )
        }
        ...
        sortView.setCardBackgroundColor(
            resources.getColor(
                com.vavill.common.R.color.my_light_primary,
                resources.newTheme()
            )
        )
    }
